(() => {
        ...
        function pageNavigationAction(e) {
            if ("click" === e.type) {
                ...
                if (targetElement.closest("[data-goto]")) {
                    ...
                    const offsetTop = gotoLink.dataset.gotoTop ? parseInt(gotoLink.dataset.gotoTop) : 105;
    ...
    const realGotoLinks = document.querySelectorAll("[data-goto]");
    console.log(realGotoLinks);
    window["FLS"] = true;
    isWebp();
    menuInit();
    pageNavigation();
